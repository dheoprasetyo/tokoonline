      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- starFt message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{Auth::user()->photos}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ Auth::user()->photos}}" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href={{url('/user')}}><i class="fa fa-circle-o"></i> List Products</a></li>
            <li><a href={{url('/user/add')}}><i class="fa fa-circle-o"></i>Add Products</a></li>
          </ul>
        </li>
