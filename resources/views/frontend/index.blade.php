...
<html>
  ...
  <body>
    ...
    <div id="all">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="{{asset('frontend/img/logo.png')}}" alt="Universal logo" class="d-none d-md-inline-block"><img src="{{asset('frontend/img/logo-small.png')}}" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
    ...
    <script src="{{asset('frontend/vendor/waypoints/lib/jquery.waypoints.min.js')}}"> </script>
    <script src="{{asset('frontend/vendor/jquery.counterup/jquery.counterup.min.js')}}"> </script>
